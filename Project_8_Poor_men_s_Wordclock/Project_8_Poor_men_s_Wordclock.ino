...
byte shiftSpeed                   =  100;           // typical 50..255ms delay tested with one MAX7219 module 

/***  Declare and initialize actual time variables with your start time here  ***/
byte seconds                      =  0;            // Start value seconds
byte minutes                      =  3;            // Start value of the minutes
byte hours                        =  8;            // Start value of the hours
